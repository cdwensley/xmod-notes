%newcomm.tex,  version 14/05/23

%all newcommands for notes and notesdev 

%% package names, categories etc., sans serif
\newcommand{\arXiv}    {{\sf arXiv}}
\newcommand{\Cat}      {{\sf Cat}}
\newcommand{\GAP}      {{\sf GAP}}
\newcommand{\GitHub}   {{\sf GitHub}}
%\newcommand{\Gpd}      {{\sf Groupoids}}
\newcommand{\Groupoid}{{\sf Groupoid}}
