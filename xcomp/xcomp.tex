...
\begin{center}
MISSING GRAPHICS
%% \input{itensori.pstex_t}
%% \includegraphics[scale = 0.65]{xcomp/itensori.eps}
\end{center}
...
\begin{center}
MISSING GRAPHICS
%% \input{itensorc.pstex_t}
%% \includegraphics[scale = 0.65]{xcomp/itensorc.eps}
\end{center}
...
MISSING GRAPHICS
%% \input{ioioi.pstex_t}
%% \includegraphics[scale = 0.65]{xcomp/ioioi.eps}
\end{center}
...
\begin{center}
MISSING GRAPHICS
%% \input{xcomp-1hom.pstex_t}
%% \includegraphics[scale = 0.65]{xcomp/xcomp-1hom.eps}
\end{center}
...
\begin{center}
MISSING GRAPHICS
%% \input{xcomp-2hom.pstex_t}
%% \includegraphics[scale = 0.65]{xcomp/xcomp-2hom.eps}
\end{center}
...
\begin{center}
MISSING GRAPHICS
%% \input{xcomp-wprod.pstex_t}
%% \includegraphics[scale = 0.65]{xcomp/xcomp-wprod.eps}
\end{center}
